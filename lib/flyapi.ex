defmodule Clutterfly.FlyAPI do
  ...
  """
  @spec new(api_token :: String.t(), base_url :: String.t()) :: client()
  def new(api_token, base_url \\ @base_url) do
  ...
  def request(client, method, path, opts \\ []) do
    req_opts = [
      ...
      retry: Keyword.get(opts, :retry, false)  # Add retry options
    ]
    # Add any other custom Req options
    req_opts = Keyword.merge(req_opts, Keyword.drop(opts, [:timeout, :body, :params, :retry]))
