defmodule Clutterfly.FlySchemas.CreateVolumeRequest do
  use Ecto.Schema
  import Ecto.Changeset

  @primary_key false
  embedded_schema do
    embeds_one :compute, Clutterfly.FlySchemas.FlyMachineGuest
  ...
  def changeset(schema, attrs) do
    schema
        ...
        |> cast_embed(:compute, with: &Clutterfly.FlySchemas.FlyMachineGuest.changeset/2)
  end
end
